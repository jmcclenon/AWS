...
2. What is the API call used to obtain temporary security credentials when authenticating using Web
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxMTI5MzQwOSw1NTg4NzQwNzksMTM3MT
UxNTQyMSwtMzMwNTc1MThdfQ==
-->